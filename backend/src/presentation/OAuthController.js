...
class OAuthController {
  ...
  async handleLinkedInCallback(req, res, next) {
    try {
      ...
      // LinkedIn data is already saved to employees.linkedin_data column via updateLinkedInData()
      // No need for dual-write - all raw data sources are now in employees table
  ...
  async handleGitHubCallback(req, res, next) {
    try {
      ...
      // GitHub data is already saved to employees.github_data column via updateGitHubData()
      // No need for dual-write - all raw data sources are now in employees table
