...
**Replace `https://your-rag-service.com` with your actual RAG service URL.**
...
This is the script that gets loaded from your RAG service. Here's what it does:
...
**Causes:**
- RAG service not serving bundle
- Wrong URL
- CORS issue
- Network error
...
1. **Verify RAG service is running:**
   ```bash
   curl https://rag-service.com/health
   ```

2. **Check bundle URL:**
   ```bash
   curl https://rag-service.com/embed/bot-bundle.js
...
**Error:**
```
Access to fetch at 'https://rag-service.com/api/assessment/support' 
...
4. **Test with curl:**
   ```bash
   curl -X POST https://rag-service.com/api/assessment/support \
...
2. **Load script:** `<script src="https://rag-service.com/embed/bot.js"></script>`
